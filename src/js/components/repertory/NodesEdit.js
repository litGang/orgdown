...
let select = (state) => ({
  commonPassword: '444' || state.settings.settings.nodesCommonPassword,
  commonUserName: '222' || state.settings.settings.nodesCommonUserName,
  productName: 'orgdown' || state.settings.productName.short,
  nodes: [{address: '127.0.0.1'}, {address: '127.0.0.2'}] || state.settings.settings.nodes,
