...
let select = (state) => ({
	index: {
		sort: 'modified:desc', result: {
			items: [
				{name: 'new note', url: '12', state: 'Online', modified: TODAY},
				{name: 'new note', url: '12', state: 'Online', modified: TODAY},
				{name: 'new note', url: '12', state: 'Online', modified: TODAY},
				{name: 'new note', url: '23', state: 'Online', modified: TODAY},
				{name: 'new note', url: '123', state: 'Online', modified: TODAY},
				{name: 'new note', url: '123', state: 'Online', modified: LAST_7},
				{name: 'new note', url: '12312', state: 'Online', modified: LAST_7},
				{name: 'new note', url: '12313', state: 'Online', modified: LAST_7},
				{name: 'new note', url: '12312', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '123123', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '12314123', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '12312', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '123123', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '12314123', state: 'Online', modified: LAST_30},
				{name: 'new note', url: '12312', state: 'Online', modified: LAST_30},
